...
public class RssHandler extends DefaultHandler {
	...
	String lastElementName = "";// 标记变量，用于标记在解析过程中我们关心的几个标签，若不是我们关心的标记为0
	final int RSS_TITLE = 1;// 若是title标签，几做1，注意有两个title，但我们都保存item的成员变量中
	...
	public void startElement(String uri, String localName, String qName,
		...
		if ("chanel".equals(localName)) {
			// 这个标签内没有我们关心的内容，所以不做处理currentFlag=0
			currentFlag = 0;
			return;
		}
	...
	public void endElement(String uri, String localName, String qName)
		...
		// 如果解析一个item节点结，就将rssItem添加到rssFeed中
		if ("item".equals(localName)) {
